...
public class RedissonConfiguration {
    ...
    public RedissonClient redisson(UnifiedObservationFactory unifiedObservationFactory) throws IOException {
        ...
        if (redissonProperties.getConfig() != null) {
            ...
            Optional.ofNullable(redisProperties.getLettuce())
                    ...
                    .ifPresent(size -> {
                        singleServerConfig.setConnectionPoolSize(size);
                        singleServerConfig.setSubscriptionConnectionPoolSize(size);
                    });
        ...
        return new ObservedRedissonClient(
                Redisson.create(config), unifiedObservationFactory
        );
    }
