 ...
 */
@JsonPropertyOrder({
  INVALIDCURRENCYCODE.JSON_PROPERTY_ISSUE,
  INVALIDCURRENCYCODE.JSON_PROPERTY_DESCRIPTION
})
@JsonTypeName("INVALID_CURRENCY_CODE")
...
public class INVALIDCURRENCYCODE {
  ...
  public enum DescriptionEnum {
    CURRENCY_CODE_IS_INVALID_OR_IS_NOT_CURRENTLY_SUPPORTED_PLEASE_REFER_HTTPS_DEVELOPER_PAYPAL_COM_DOCS_API_REFERENCE_CURRENCY_CODES_FOR_LIST_OF_SUPPORTED_CURRENCY_CODES_("Currency code is invalid or is not currently supported. Please refer https://developer.paypal.com/docs/api/reference/currency-codes/ for list of supported currency codes.");
  ...
  public INVALIDCURRENCYCODE issue(IssueEnum issue) {
  ...
  **/
  ...
  public INVALIDCURRENCYCODE description(DescriptionEnum description) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    INVALIDCURRENCYCODE INVALID_CURRENCY_CODE = (INVALIDCURRENCYCODE) o;
    return Objects.equals(this.issue, INVALID_CURRENCY_CODE.issue) &&
        Objects.equals(this.description, INVALID_CURRENCY_CODE.description);
  }
  ...
  public String toString() {
    ...
    sb.append("class INVALIDCURRENCYCODE {\n");
