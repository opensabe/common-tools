 ...
 */
@JsonPropertyOrder({
  REFUNDISRESTRICTED.JSON_PROPERTY_ISSUE,
  REFUNDISRESTRICTED.JSON_PROPERTY_DESCRIPTION
})
@JsonTypeName("REFUND_IS_RESTRICTED")
...
public class REFUNDISRESTRICTED {
  ...
  public enum DescriptionEnum {
    THIS_REFUND_CAN_ONLY_BE_PROCESSED_BY_THE_API_CALLER_THAT_HAD_CAPTURED_THE_TRANSACTION_IF_YOU_FACILITATE_YOUR_TRANSACTIONS_VIA_A_PLATFORM_PARTNER_PLEASE_INITIATE_A_REFUND_THROUGH_THEM_("This refund can only be processed by the API caller that had 'captured' the transaction. If you facilitate your transactions via a platform/partner, please initiate a refund through them.");
  ...
  public REFUNDISRESTRICTED issue(IssueEnum issue) {
  ...
  **/
  ...
  public REFUNDISRESTRICTED description(DescriptionEnum description) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    REFUNDISRESTRICTED REFUND_IS_RESTRICTED = (REFUNDISRESTRICTED) o;
    return Objects.equals(this.issue, REFUND_IS_RESTRICTED.issue) &&
        Objects.equals(this.description, REFUND_IS_RESTRICTED.description);
  }
  ...
  public String toString() {
    ...
    sb.append("class REFUNDISRESTRICTED {\n");
