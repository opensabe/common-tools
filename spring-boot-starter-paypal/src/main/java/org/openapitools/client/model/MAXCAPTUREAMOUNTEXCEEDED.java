 ...
 */
@JsonPropertyOrder({
  MAXCAPTUREAMOUNTEXCEEDED.JSON_PROPERTY_ISSUE,
  MAXCAPTUREAMOUNTEXCEEDED.JSON_PROPERTY_DESCRIPTION
})
@JsonTypeName("MAX_CAPTURE_AMOUNT_EXCEEDED")
...
public class MAXCAPTUREAMOUNTEXCEEDED {
  ...
  public enum DescriptionEnum {
    CAPTURE_AMOUNT_EXCEEDS_ALLOWABLE_LIMIT_PLEASE_CONTACT_CUSTOMER_SERVICE_OR_YOUR_ACCOUNT_MANAGER_TO_REQUEST_THE_CHANGE_TO_YOUR_OVERAGE_LIMIT_THE_DEFAULT_OVERAGE_LIMIT_IS_115_WHICH_ALLOWS_THE_SUM_OF_ALL_CAPTURES_TO_BE_UP_TO_115_OF_THE_ORDER_AMOUNT_THE_ABILITY_TO_OVER_CAPTURE_IS_SUBJECTED_TO_REGULATORY_APPROVALS_("Capture amount exceeds allowable limit. Please contact customer service or your account manager to request the change to your overage limit. The default overage limit is 115%, which allows the sum of all captures to be up to 115% of the order amount. The ability to over capture is subjected to regulatory approvals.");
  ...
  public MAXCAPTUREAMOUNTEXCEEDED issue(IssueEnum issue) {
  ...
  **/
  ...
  public MAXCAPTUREAMOUNTEXCEEDED description(DescriptionEnum description) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    MAXCAPTUREAMOUNTEXCEEDED MAX_CAPTURE_AMOUNT_EXCEEDED = (MAXCAPTUREAMOUNTEXCEEDED) o;
    return Objects.equals(this.issue, MAX_CAPTURE_AMOUNT_EXCEEDED.issue) &&
        Objects.equals(this.description, MAX_CAPTURE_AMOUNT_EXCEEDED.description);
  }
  ...
  public String toString() {
    ...
    sb.append("class MAXCAPTUREAMOUNTEXCEEDED {\n");
