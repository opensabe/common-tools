 ...
 */
@JsonPropertyOrder({
  MAXCAPTURECOUNTEXCEEDED.JSON_PROPERTY_ISSUE,
  MAXCAPTURECOUNTEXCEEDED.JSON_PROPERTY_DESCRIPTION
})
@JsonTypeName("MAX_CAPTURE_COUNT_EXCEEDED")
...
public class MAXCAPTURECOUNTEXCEEDED {
  ...
  public enum DescriptionEnum {
    MAXMIMUM_NUMBER_OF_ALLOWABLE_CAPTURES_HAS_BEEN_REACHED_NO_ADDITIONAL_CAPTURES_ARE_POSSIBLE_FOR_THIS_AUTHORIZATION_CONTACT_CUSTOMER_SERVICE_OR_YOUR_ACCOUNT_MANAGER_TO_CHANGE_THE_NUMBER_OF_CAPTURES_FOR_A_GIVEN_AUTHORIZATION_("Maxmimum number of allowable captures has been reached. No additional captures are possible for this authorization. Contact Customer Service or your account manager to change the number of captures for a given authorization.");
  ...
  public MAXCAPTURECOUNTEXCEEDED issue(IssueEnum issue) {
  ...
  **/
  ...
  public MAXCAPTURECOUNTEXCEEDED description(DescriptionEnum description) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    MAXCAPTURECOUNTEXCEEDED MAX_CAPTURE_COUNT_EXCEEDED = (MAXCAPTURECOUNTEXCEEDED) o;
    return Objects.equals(this.issue, MAX_CAPTURE_COUNT_EXCEEDED.issue) &&
        Objects.equals(this.description, MAX_CAPTURE_COUNT_EXCEEDED.description);
  }
  ...
  public String toString() {
    ...
    sb.append("class MAXCAPTURECOUNTEXCEEDED {\n");
