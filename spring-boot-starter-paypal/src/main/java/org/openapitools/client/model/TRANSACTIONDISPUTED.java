 ...
 */
@JsonPropertyOrder({
        TRANSACTIONDISPUTED.JSON_PROPERTY_ISSUE,
        TRANSACTIONDISPUTED.JSON_PROPERTY_DESCRIPTION
})
@JsonTypeName("TRANSACTION_DISPUTED")
...
public class TRANSACTIONDISPUTED {
    ...
    public TRANSACTIONDISPUTED issue(IssueEnum issue) {
    ...
    public TRANSACTIONDISPUTED description(DescriptionEnum description) {
    ...
    public boolean equals(Object o) {
        ...
        TRANSACTIONDISPUTED TRANSACTION_DISPUTED = (TRANSACTIONDISPUTED) o;
        return Objects.equals(this.issue, TRANSACTION_DISPUTED.issue) &&
                Objects.equals(this.description, TRANSACTION_DISPUTED.description);
    }
    ...
    public String toString() {
        ...
        sb.append("class TRANSACTIONDISPUTED {\n");
    ...
    public enum DescriptionEnum {
        PARTIAL_REFUNDS_CANNOT_BE_OFFERED_AT_THIS_TIME_BECAUSE_THERE_IS_AN_OPEN_CASE_ON_THIS_TRANSACTION_VISIT_THE_PAYPAL_RESOLUTION_CENTER_TO_REVIEW_THIS_CASE_("Partial refunds cannot be offered at this time because there is an open case on this transaction. Visit the PayPal Resolution Center to review this case.");
