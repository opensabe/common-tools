...
public enum PaymentPattern {
  ...
  CUSTOMER_PRESENT_ONETIME_PURCHASE("CUSTOMER_PRESENT_ONETIME_PURCHASE"),
  
  CUSTOMER_NOT_PRESENT_RECURRING("CUSTOMER_NOT_PRESENT_RECURRING"),
  
  CUSTOMER_PRESENT_RECURRING_FIRST("CUSTOMER_PRESENT_RECURRING_FIRST"),
  
  CUSTOMER_PRESENT_ONETIME_PURCHASE_VAULTED("CUSTOMER_PRESENT_ONETIME_PURCHASE_VAULTED"),
  
  CUSTOMER_NOT_PRESENT_ONETIME_PURCHASE_VAULTED("CUSTOMER_NOT_PRESENT_ONETIME_PURCHASE_VAULTED"),
  
  MAIL_ORDER_TELEPHONE_ORDER("MAIL_ORDER_TELEPHONE_ORDER");

  private String value;

  PaymentPattern(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static PaymentPattern fromValue(String value) {
    for (PaymentPattern b : PaymentPattern.values()) {
