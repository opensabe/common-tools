 ...
 */
@JsonPropertyOrder({
  CaptureAllOf.JSON_PROPERTY_ID,
  CaptureAllOf.JSON_PROPERTY_AMOUNT,
  CaptureAllOf.JSON_PROPERTY_INVOICE_ID,
  CaptureAllOf.JSON_PROPERTY_CUSTOM_ID,
  CaptureAllOf.JSON_PROPERTY_NETWORK_TRANSACTION_REFERENCE,
  CaptureAllOf.JSON_PROPERTY_SELLER_PROTECTION,
  CaptureAllOf.JSON_PROPERTY_FINAL_CAPTURE,
  CaptureAllOf.JSON_PROPERTY_SELLER_RECEIVABLE_BREAKDOWN,
  CaptureAllOf.JSON_PROPERTY_DISBURSEMENT_MODE,
  CaptureAllOf.JSON_PROPERTY_LINKS,
  CaptureAllOf.JSON_PROPERTY_PROCESSOR_RESPONSE
})
@JsonTypeName("capture_allOf")
...
public class CaptureAllOf {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, amount, invoiceId, customId, networkTransactionReference, sellerProtection, finalCapture, sellerReceivableBreakdown, disbursementMode, links, processorResponse);
  }
