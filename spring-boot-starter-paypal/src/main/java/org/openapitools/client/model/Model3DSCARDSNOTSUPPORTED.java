...
/**
 * Model3DSCARDSNOTSUPPORTED
 */
@JsonPropertyOrder({
  Model3DSCARDSNOTSUPPORTED.JSON_PROPERTY_ISSUE,
  Model3DSCARDSNOTSUPPORTED.JSON_PROPERTY_DESCRIPTION
})
@JsonTypeName("_3DS_CARDS_NOT_SUPPORTED")
...
public class Model3DSCARDSNOTSUPPORTED {
  /**
   * Gets or Sets issue
   */
  public enum IssueEnum {
    _3DS_CARDS_NOT_SUPPORTED("3DS_CARDS_NOT_SUPPORTED");
  ...
  public enum DescriptionEnum {
    CARDS_THAT_REQUIRE_3DS_AUTHENTICATION_NOT_SUPPORTED_("Cards that require 3DS authentication not supported.");
  ...
  public Model3DSCARDSNOTSUPPORTED() {
  }

  public Model3DSCARDSNOTSUPPORTED issue(IssueEnum issue) {
  ...
  **/
  ...
  public Model3DSCARDSNOTSUPPORTED description(DescriptionEnum description) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    Model3DSCARDSNOTSUPPORTED _3DS_CARDS_NOT_SUPPORTED = (Model3DSCARDSNOTSUPPORTED) o;
    return Objects.equals(this.issue, _3DS_CARDS_NOT_SUPPORTED.issue) &&
        Objects.equals(this.description, _3DS_CARDS_NOT_SUPPORTED.description);
  }
  ...
  public String toString() {
    ...
    sb.append("class Model3DSCARDSNOTSUPPORTED {\n");
