 ...
 */
@JsonPropertyOrder({
  INVALIDPATCHPATH1.JSON_PROPERTY_ISSUE,
  INVALIDPATCHPATH1.JSON_PROPERTY_DESCRIPTION
})
@JsonTypeName("INVALID_PATCH_PATH_1")
...
public class INVALIDPATCHPATH1 {
  /**
   * Gets or Sets issue
   */
  ...
  public enum DescriptionEnum {
    MULTIPLE_OPERATIONS_ON_THE_SAME_FIELD_ARE_NOT_ALLOWED_("Multiple operations on the same field are not allowed.");
  ...
  public INVALIDPATCHPATH1() {
  }

  public INVALIDPATCHPATH1 issue(IssueEnum issue) {
  ...
  **/
  ...
  public INVALIDPATCHPATH1 description(DescriptionEnum description) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    INVALIDPATCHPATH1 INVALID_PATCH_PATH_1 = (INVALIDPATCHPATH1) o;
    return Objects.equals(this.issue, INVALID_PATCH_PATH_1.issue) &&
        Objects.equals(this.description, INVALID_PATCH_PATH_1.description);
  }
  ...
  public String toString() {
    ...
    sb.append("class INVALIDPATCHPATH1 {\n");
