 ...
 */
@JsonPropertyOrder({
  DECIMALPRECISION.JSON_PROPERTY_ISSUE,
  DECIMALPRECISION.JSON_PROPERTY_DESCRIPTION
})
@JsonTypeName("DECIMAL_PRECISION")
...
public class DECIMALPRECISION {
  ...
  public enum DescriptionEnum {
    IF_THE_CURRENCY_SUPPORTS_DECIMALS_ONLY_TWO_DECIMAL_PLACE_PRECISION_IS_SUPPORTED_("If the currency supports decimals, only two decimal place precision is supported.");
  ...
  public DECIMALPRECISION issue(IssueEnum issue) {
  ...
  **/
  ...
  public DECIMALPRECISION description(DescriptionEnum description) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DECIMALPRECISION DECIMAL_PRECISION = (DECIMALPRECISION) o;
    return Objects.equals(this.issue, DECIMAL_PRECISION.issue) &&
        Objects.equals(this.description, DECIMAL_PRECISION.description);
  }
  ...
  public String toString() {
    ...
    sb.append("class DECIMALPRECISION {\n");
