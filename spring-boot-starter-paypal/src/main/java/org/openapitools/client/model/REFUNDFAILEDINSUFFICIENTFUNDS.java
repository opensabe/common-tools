 ...
 */
@JsonPropertyOrder({
        REFUNDFAILEDINSUFFICIENTFUNDS.JSON_PROPERTY_ISSUE,
        REFUNDFAILEDINSUFFICIENTFUNDS.JSON_PROPERTY_DESCRIPTION
})
@JsonTypeName("REFUND_FAILED_INSUFFICIENT_FUNDS")
...
public class REFUNDFAILEDINSUFFICIENTFUNDS {
    ...
    public REFUNDFAILEDINSUFFICIENTFUNDS issue(IssueEnum issue) {
    ...
    public REFUNDFAILEDINSUFFICIENTFUNDS description(DescriptionEnum description) {
    ...
    public boolean equals(Object o) {
        ...
        REFUNDFAILEDINSUFFICIENTFUNDS REFUND_FAILED_INSUFFICIENT_FUNDS = (REFUNDFAILEDINSUFFICIENTFUNDS) o;
        return Objects.equals(this.issue, REFUND_FAILED_INSUFFICIENT_FUNDS.issue) &&
                Objects.equals(this.description, REFUND_FAILED_INSUFFICIENT_FUNDS.description);
    }
    ...
    public String toString() {
        ...
        sb.append("class REFUNDFAILEDINSUFFICIENTFUNDS {\n");
    ...
    public enum DescriptionEnum {
        CAPTURE_COULD_NOT_BE_REFUNDED_DUE_TO_INSUFFICIENT_FUNDS_PLEASE_CHECK_TO_SEE_IF_YOU_HAVE_SUFFICIENT_FUNDS_IN_YOUR_PAYPAL_ACCOUNT_OR_IF_THE_BANK_ACCOUNT_LINKED_TO_YOUR_PAYPAL_ACCOUNT_IS_VERIFIED_AND_HAS_SUFFICIENT_FUNDS_("Capture could not be refunded due to insufficient funds. Please check to see if you have sufficient funds in your PayPal account or if the bank account linked to your PayPal account is verified and has sufficient funds.");
