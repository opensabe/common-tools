 ...
 */
@JsonPropertyOrder({
  CANNOTBEZEROORNEGATIVE.JSON_PROPERTY_ISSUE,
  CANNOTBEZEROORNEGATIVE.JSON_PROPERTY_DESCRIPTION
})
@JsonTypeName("CANNOT_BE_ZERO_OR_NEGATIVE")
...
public class CANNOTBEZEROORNEGATIVE {
  ...
  public enum DescriptionEnum {
    MUST_BE_GREATER_THAN_ZERO_IF_THE_CURRENCY_SUPPORTS_DECIMALS_ONLY_TWO_DECIMAL_PLACE_PRECISION_IS_SUPPORTED_("Must be greater than zero. If the currency supports decimals, only two decimal place precision is supported.");
  ...
  public CANNOTBEZEROORNEGATIVE issue(IssueEnum issue) {
  ...
  **/
  ...
  public CANNOTBEZEROORNEGATIVE description(DescriptionEnum description) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    CANNOTBEZEROORNEGATIVE CANNOT_BE_ZERO_OR_NEGATIVE = (CANNOTBEZEROORNEGATIVE) o;
    return Objects.equals(this.issue, CANNOT_BE_ZERO_OR_NEGATIVE.issue) &&
        Objects.equals(this.description, CANNOT_BE_ZERO_OR_NEGATIVE.description);
  }
  ...
  public String toString() {
    ...
    sb.append("class CANNOTBEZEROORNEGATIVE {\n");
