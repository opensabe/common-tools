 ...
 */
@JsonPropertyOrder({
  DECIMALSNOTSUPPORTED.JSON_PROPERTY_ISSUE,
  DECIMALSNOTSUPPORTED.JSON_PROPERTY_DESCRIPTION
})
@JsonTypeName("DECIMALS_NOT_SUPPORTED")
...
public class DECIMALSNOTSUPPORTED {
  ...
  public enum DescriptionEnum {
    CURRENCY_DOES_NOT_SUPPORT_DECIMALS_PLEASE_REFER_TO_HTTPS_DEVELOPER_PAYPAL_COM_DOCS_API_REFERENCE_CURRENCY_CODES_FOR_MORE_INFORMATION_("Currency does not support decimals. Please refer to https://developer.paypal.com/docs/api/reference/currency-codes/ for more information.");
  ...
  public DECIMALSNOTSUPPORTED issue(IssueEnum issue) {
  ...
  **/
  ...
  public DECIMALSNOTSUPPORTED description(DescriptionEnum description) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    DECIMALSNOTSUPPORTED DECIMALS_NOT_SUPPORTED = (DECIMALSNOTSUPPORTED) o;
    return Objects.equals(this.issue, DECIMALS_NOT_SUPPORTED.issue) &&
        Objects.equals(this.description, DECIMALS_NOT_SUPPORTED.description);
  }
  ...
  public String toString() {
    ...
    sb.append("class DECIMALSNOTSUPPORTED {\n");
