...
/**
 * 管理后台参数校验工具：失败时抛出 {@link BackendException}，不做国际化。
 */
...
public final class BackendCheckUtils {
     ...
     * @param message    如果为 false，抛出的异常信息
     * @param data       返回给前端的结果
     * @throws BackendException 如果表达式为 false
     */
     ...
     *
     * @param expression 要判断的表达式
     * @param message    如果为 true，抛出的异常信息
     * @param data       返回给前端的结果
     * @throws BackendException 如果表达式为 true
     */
     ...
     *
     * @param map     要判断的 Map
     * @param message 如果 Map 为空，抛出的异常信息
     * @throws BackendException 如果 Map 为空
